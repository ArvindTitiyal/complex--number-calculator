...
class complex_numbers:
    ...
    def __truediv__(self, other):
        if other.real*other.real + other.imag*other.imag != 0:
            return complex_numbers((self.real*other.real + self.imag*other.imag) / (other.real*other.real + other.imag*other.imag), (self.imag*other.real - self.real*other.imag) / (other.real*other.real + other.imag*other.imag))
        else:
